...
// Land Generation Mechanism v1.1
...
ruler_type= [' ', ' ', ' ', ' ', ' '];
ruler_type[0]=['ATTACK BONUS', 0.2]
ruler_type[1]=['DEFENSE BONUS', 0.2]
ruler_type[2]=['TRADE BONUS', 0.2]
ruler_type[3]=['RESOURCE BONUS', 0.2]
ruler_type[4]=['EXPANSION BONUS', 0.2]
